                ...
                <div key={cat} className="space-y-1">
                  <button
                    ...
                    className={`flex w-full items-center justify-between group py-2 text-left transition-all duration-300
                      ${isCatActive ? 'text-primary-600 pl-2' : 'text-dark-deep/50 hover:text-dark-deep'}`}
                  >
                  ...
                  {hasSubcategories && isCatActive && (
                    <div className="pl-4 flex flex-col gap-2 mt-2 border-l border-dark-deep/10 ml-2 animate-in slide-in-from-top-2 fade-in duration-300">
                        ...
                        return (
                          <button
                            ...
                            className={`text-[11px] text-left uppercase font-black tracking-[0.2em] transition-all duration-300
                              ${isSubActive ? 'text-dark-deep pl-1 before:content-["—"] before:mr-2 before:text-primary-600' : 'text-dark-deep/40 hover:text-dark-deep'}
                            `}
                          >
                            {sub}
                          </button>
