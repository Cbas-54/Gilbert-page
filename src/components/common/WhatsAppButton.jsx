...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-16 h-16 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-12 border-4 border-white/10">
        <svg 
          viewBox="0 0 24 24" 
